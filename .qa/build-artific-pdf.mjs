  ...
  source: {
    ...
    inventoryItems: [
      ...
      },
      {
        ...
        category: "wondrous",
        includeInItemDescriptions: true,
        sheetDescription: "<p><strong>Prayer Beads (Signature Item, Wondrous)</strong></p><p><strong>Bead Count:</strong> 25 beads (some have symbols, some don't yet). <strong>Usage:</strong> Each bead can be used once per long rest.</p><p><strong>Activation:</strong> Requires a **Bonus Action** to use a bead.</p><p><strong>Praying Mantis Style</strong> <strong>Swiftness</strong> <strong>Effect:</strong> As part of that action you make, you can also move up to 15 ft. towards a target without provoking opportunity attacks.</p><p><strong>Saving Face:</strong> When you fail a Charisma (Deception) check, you can use your reaction to reroll the check with a bonus equal to your Wisdom modifier. Once used, this property can't be used again until you finish a long rest.</p>",
      },
    ],
