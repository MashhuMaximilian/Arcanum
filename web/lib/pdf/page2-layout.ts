...
export const PAGE2_COMPANION_REGIONS = {
  ...
  // Three-column layout
  // Left: Portrait (25%) + Ability Scores (below portrait, 75%)
  portrait: { x: 10, y: 40, width: 120, height: 120 },
  abilityScores: { x: 10, y: 168, width: 120, height: 140 },

  // Center: HP strip, Saves/Prof/Init/Speed, Languages
  hpStrip: { x: 138, y: 40, width: 250, height: 50 },
  statsRow: { x: 138, y: 98, width: 250, height: 36 },
  savesAndSkills: { x: 138, y: 140, width: 250, height: 100 },
  sensesAndLangs: { x: 138, y: 248, width: 250, height: 60 },
